...
unit_blueprint = Blueprint('unit', __name__, url_prefix='/unit')
...
model_name = "0404_user_w_100d_w15_m1_e400.bin"
# model_name = 'docmodel'
...
找相似句
'''
@unit_blueprint.route('', methods=['GET', 'POST'])
def test():
    ...
    if res[0][1] < 0.85:
        ...
        # 取出被标记为未更新的内容
        sql = "SELECT question,aswer,Level_1_department FROM faq_user WHERE fenci_q="+"'"+res[0][2]+"'"
        print sql
