...
class DevelopConfig(Config):
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = 'mysql://ai_dev:dev2018@centerai.cn@154.8.214.203:3306/ccc_data'
    #SQLALCHEMY_DATABASE_URI = 'mysql://root:mysql@localhost:3306/ccc_data'
class ProductConfig(Config):
    # SQLALCHEMY_DATABASE_URI = 'mysql://root:mysql@localhost:3306/x'
    pass
