...
for i in range(1, 274):
    # http://wenda.viptijian.com/all/2?&p=2
    url = "http://wenda.viptijian.com/all/2?&p={}".format(i)
    print(url)
    ...
    try:
        ...
        li_href_list = html1.xpath('//*[@class="ask-list-one"]/div[1]/div[1]/a/@href')
        # print(li_href_list)

        for url_href in li_href_list:
            data_dic = {}
            ...
            try:
                ...
                questions_list = html2.xpath('//*[@class="ask-body-left"]/div[1]/div[1]/pre/text()')
                ...
                if len(questions_list) != 0:
                    try:
                        answer_list = html2.xpath('//*[@class="ask-answer-lists-box"]/div[1]/pre/text()')
                        # print(answer_list)
                        ...
                        if len(answer_list) != 0:
                            ...
                            print(ask_dic_json)
                            with open('./zktj_ask.json', 'a+', encoding='utf-8') as f:
