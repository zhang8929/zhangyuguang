...
with open('./cnkang_href_over.txt', 'r', encoding='utf-8') as f:
    data = f.readlines()
    # print(data)


for url in data[3000:]:
    # print(111, url.strip())
    try:
        ...
        li_url_list = html.xpath('//*[@class="iask12_con"]/dl/dt/a/@href')
        print(li_url_list)

        for li_url in li_url_list:
            url2 = "http://www.cnkang.com"+ li_url +""
            # print(url2)
            ...
            ask_dic = {}
            try:
                questions_list = html2.xpath('//*[@class="iask13 iask13_q"]/ul/text()')
                # print(questions_list)
                question = questions_list[1].strip()
                print(question)
            ...
            try:
                answer_list = html2.xpath('//*[@class="iask13 iask13_a"]/ul[2]/text()')
                # print(answer_list)
                answer = answer_list[1].strip()
                print(answer)
                ask_dic["answer"] = answer
            except:
                ask_dic["answer"] = ""
            # print(ask_dic)

            ask_dic_json = str(ask_dic)
            with open('./cnkang_ask.json', 'a+', encoding='utf-8') as f:
