...
if __name__ == '__main__':
    prepare_zz('/Users/zhangyuan/work/爬虫数据/名医在线/mingyizaixian-zhengzhuang.json','/Users/zhangyuan/work/爬虫数据/名医在线/myzx_zhengzhuang_ready.json')