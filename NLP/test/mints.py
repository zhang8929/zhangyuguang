...
class IntentParser (object) :
    ...
    def __init__(self) :
        ...
        self.__train_file_path = os.path.dirname(os.path.realpath(__file__))  +\
            '/../database/ignore/intent.txt'
    ...
    def get_intents (self) :
        ...
        with open(self.__train_file_path, 'r') as fh :
            s = fh.read()
            lines = s.split("\n")
            index = 0
            for l in lines :
